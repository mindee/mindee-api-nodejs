 ...
 * @returns bool
 */
export function isValidSyncResponse(response: BaseHttpResponse): boolean {
 ...
 * @returns bool
 */
export function isValidAsyncResponse(response: BaseHttpResponse): boolean {
 ...
 */
export function cleanRequestData(response: BaseHttpResponse): BaseHttpResponse {
