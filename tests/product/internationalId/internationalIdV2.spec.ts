...
const dataPath = {
  complete: "tests/data/products/international_id/response_v2/complete.json",
  empty: "tests/data/products/international_id/response_v2/empty.json",
  docString: "tests/data/products/international_id/response_v2/summary_full.rst",
  page0String: "tests/data/products/international_id/response_v2/summary_page0.rst",
};

describe("InternationalIdV2 Object initialization", async () => {
