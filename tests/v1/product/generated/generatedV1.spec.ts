...
describe("Generated Document Object initialization on an OTS invoice", async () => {
  ...
  it("should load a single page prediction", async () => {
    ...
    expect(page.prediction.fields.get("supplier_payment_details").values[0].iban).to.equals(
      "FR7640254025476501124705368"
    );
    expect(page.prediction.fields.get("taxes").values[0].polygon.polygon).to.have.deep.members(
  ...
  it("should load a complete document prediction", async () => {
    ...
    expect(doc.inference.prediction.fields.get("line_items").values[0].description).to.equals(
    ...
    expect(doc.inference.prediction.fields.get("supplier_address").value).to.equals(
    ...
    expect(doc.inference.prediction.fields.get("supplier_payment_details").values[0].iban).to.equals(
      "FR7640254025476501124705368"
    );
    expect(doc.inference.prediction.fields.get("taxes").values[0].polygon.polygon).to.have.deep.members(
      [[0.292, 0.749], [0.543, 0.749], [0.543, 0.763], [0.292, 0.763]]
    );
